...
class Solution:
    ...
    def lowestCommonAncestor(self, root: TreeNode, p: TreeNode, q: TreeNode) -> TreeNode:
        ...
        # lowestCommonAncestor(root, p, q) For the subtree rooted at root, return its LCA if it contains both p and q; otherwise return the one target it contains, or None if it contains neither.
